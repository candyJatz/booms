...
switch ($nomTipo) {
    case 'Tarjeta1':
        $colorL = "200, 140, 36";
        $parrafo = "especial desde 1945, ediccion especial <br> Estamos en la tarjeta 1";
        $type = "Tarjeta 1";
        break;
    case 'Tarjeta2':
        $colorL = "0, 0, 255";
        $parrafo = " curso de venta maxima en comics <br> Estamos en la tarjeta 2 ";
        $type = "Tarjeta 2";
        break;
    case 'Tarjeta3':
        $colorL = "255, 255, 0";
        $parrafo = "especial comic num51 <br> Estamos en la tarjeta 3";
        $type = "Tarjeta 3";
        break;
...
<body style="background-color: rgb(1, 0, 54);font-family: 'Comic Sans MS', cursive;">
    ...
    $id = "1";
    $titulo = $type;
    $desP = ' suspecho, misterio, y mas, solo aqui y ahora,  no te lo puedes perder ';
    $url = '../img/cocc3.jpg';
    ?>
